...
def solute_site_preference_finder_new(
        structure, e0, T, vac_defs, antisite_defs,  solute_defs,
        solute_concen=0.01, trial_chem_pot = None):
    ...
    site_pref_data['y_label'] = "Fraction of {} at {} sites".format(
        solute_specie,els[0])
...
def solute_defect_density(structure, e0, vac_defs, antisite_defs, solute_defs,
    ...
    solute_site_pref_data, def_conc_data = solute_site_preference_finder_new(
        structure, e0, T, vac_defs, antisite_defs, solute_defs,
